...
var isRelationshipField$1 = (function (fieldName) {
...
var Source = function Source(body, name, locationOffset) {
  _defineProperty$4(this, "body", void 0);

  _defineProperty$4(this, "name", void 0);

  _defineProperty$4(this, "locationOffset", void 0);
...
function () {
  ...
  initialType) {
    _defineProperty$5(this, "_schema", void 0);

    _defineProperty$5(this, "_typeStack", void 0);

    _defineProperty$5(this, "_parentTypeStack", void 0);

    _defineProperty$5(this, "_inputTypeStack", void 0);

    _defineProperty$5(this, "_fieldDefStack", void 0);

    _defineProperty$5(this, "_defaultValueStack", void 0);

    _defineProperty$5(this, "_directive", void 0);

    _defineProperty$5(this, "_argument", void 0);

    _defineProperty$5(this, "_enumValue", void 0);

    _defineProperty$5(this, "_getFieldDef", void 0);
...
function () {
  function PairSet() {
    _defineProperty$8(this, "_data", void 0);
...
function () {
  function ASTValidationContext(ast) {
    _defineProperty$9(this, "_ast", void 0);

    _defineProperty$9(this, "_errors", void 0);
...
function (_ASTValidationContext) {
  ...
  function SDLValidationContext(ast, schema) {
    ...
    _defineProperty$9(_assertThisInitialized(_assertThisInitialized(_this)), "_schema", void 0);
...
function (_ASTValidationContext2) {
  ...
  function ValidationContext(schema, ast, typeInfo) {
    ...
    _defineProperty$9(_assertThisInitialized(_assertThisInitialized(_this2)), "_schema", void 0);

    _defineProperty$9(_assertThisInitialized(_assertThisInitialized(_this2)), "_typeInfo", void 0);

    _defineProperty$9(_assertThisInitialized(_assertThisInitialized(_this2)), "_fragments", void 0);

    _defineProperty$9(_assertThisInitialized(_assertThisInitialized(_this2)), "_fragmentSpreads", void 0);

    _defineProperty$9(_assertThisInitialized(_assertThisInitialized(_this2)), "_recursivelyReferencedFragments", void 0);

    _defineProperty$9(_assertThisInitialized(_assertThisInitialized(_this2)), "_variableUsages", void 0);

    _defineProperty$9(_assertThisInitialized(_assertThisInitialized(_this2)), "_recursiveVariableUsages", void 0);
...
function coerceValue(value, type, blameNode, path) {
  ...
  if (isInputObjectType(type)) {
    ...
    for (var fieldName in fields) {
      if (hasOwnProperty$2.call(fields, fieldName)) {
    ...
    for (var _fieldName in value) {
      if (hasOwnProperty$2.call(value, _fieldName)) {
...
function assertValidExecutionArguments(schema, document, rawVariableValues) {
  ...
  !(!rawVariableValues || _typeof$4(rawVariableValues) === 'object') ? invariant(0, 'Variables must be provided as an Object where each property is a ' + 'variable value. Perhaps look to see if an unparsed JSON string ' + 'was provided.') : void 0;
}
/**
...
function defaultResolveTypeFn(value, contextValue, info, abstractType) {
  ...
  if (value !== null && _typeof$4(value) === 'object' && typeof value.__typename === 'string') {
...
var defaultFieldResolver = function defaultFieldResolver(source, args, contextValue, info) {
  ...
  if (_typeof$4(source) === 'object' || typeof source === 'function') {
 ...
 *  strict
 */
function graphql$1(argsOrSchema, source, rootValue, contextValue, variableValues, operationName, fieldResolver) {
...
function () {
  function ASTDefinitionBuilder(typeDefinitionsMap, options, resolveType) {
    _defineProperty$11(this, "_typeDefinitionsMap", void 0);

    _defineProperty$11(this, "_options", void 0);

    _defineProperty$11(this, "_resolveType", void 0);

    _defineProperty$11(this, "_cache", void 0);
...
function extendSchema(schema, documentAST, options) {
  ...
  return new GraphQLSchema(_objectSpread$3({}, operationTypes, {
    types: types,
 ...
 *
 */
function printSchema$1(schema, options) {
...
var isInteger$4 = _core.Number.isInteger;

var isInteger$3 = createCommonjsModule(function (module) {
module.exports = { "default": isInteger$4, __esModule: true };
});

var _Number$isInteger = unwrapExports(isInteger$3);

var _graphql = ( graphql && undefined ) || graphql;
...
var _defineProperty$14 = unwrapExports(defineProperty);
...
var getFilterTypesFromData = (function (data) {
    return _Object$keys(data).reduce(function (types, key) {
        return _Object$assign({}, types, _defineProperty$14({}, getTypeFromKey(key), new GraphQLInputObjectType({
 ...
 * // }
 */
var getSchemaFromDataImport$1 = (function (data) {
    ...
    var schemaExtension = _Object$values(typesByName).reduce(function (ext, type) {
        _Object$keys(type.getFields()).filter(isRelationshipField$1).map(function (fieldName) {
...
var isRelationshipField = isRelationshipField$1;

var getSchemaFromData = getSchemaFromDataImport$1;

console.info('--->', printSchema$1);

var printSchema = printSchema$1;

exports.isRelationshipField = isRelationshipField;
exports['default'] = getSchemaFromDataImport$1;
